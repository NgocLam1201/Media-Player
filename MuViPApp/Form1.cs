...
namespace MuViPApp
{
    public partial class Form_Muvip : Form
    {
        ...
        {
            if (btn_Music_PlayerPanel_Play.Visible == true)
            {
                btn_Music_PlayerPanel_Play.Visible = false;
                btn_Music_PlayerPanel_Pause.Visible = true;
                mp3Player.stop();
            }
        ...
        {
             if (btn_Music_PlayerPanel_Pause.Visible == true)
            {
                btn_Music_PlayerPanel_Pause.Visible = false;
                btn_Music_PlayerPanel_Play.Visible = true;
                mp3Player.play();
            }
        }
